...
<button
  type="button"
  class="inline-flex items-center gap-3 rounded-full border border-border/80 bg-surface/90 px-3 py-2 text-left shadow-(--shadow-panel) backdrop-blur transition-transform duration-150 hover:-translate-y-0.5"
