...
take and verify a backup **while the old version is still running**, then stop
it, retain the previous binary, and let the new binary apply its embedded
forward migrations before serving.
