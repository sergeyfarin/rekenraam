...
func writeTransactionServiceError(w http.ResponseWriter, r *http.Request, logger *slog.Logger, action string, err error) {
	...
	case errors.Is(err, app.ErrTransactionProtected), errors.Is(err, app.ErrTransactionPosted), errors.Is(err, app.ErrTransactionVoided), errors.Is(err, app.ErrTransactionTag):
