# Backlog Before 2026-07-12 Consolidation

This is a verbatim historical snapshot retained for detailed resolution notes,
design rationale, and audit context. The live backlog is `docs/backlog.md`.
