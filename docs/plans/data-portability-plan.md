...
| **T-64** collapse the migration files into one | ✅ **final consolidation 2026-09-11**, before `v0.1.0` | The R3 schema was first consolidated after slice 6 on 2026-08-24. The complete pre-release schema was consolidated again immediately before the migration freeze; collapsing after the tag is not permitted. |
