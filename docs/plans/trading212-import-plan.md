...
7. **Same-timestamp incremental cursor + absolute nextPagePath — closed (T-17).**
   ...
   no backdated corrections) remain unverified against the live API; T-17
   itself is closed (`docs/reviews/resolved-backlog-2026-07.md`), and the
   residual risk is a live-API observation, not an open code item.
